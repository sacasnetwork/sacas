...
# Initialize chain.
sacasd init test --chain-id sacas_1317-2

# Get Genesis
wget https://archive.sacas.org/mainnet/genesis.json
mv genesis.json ~/.sacasd/config/

wget -O ~/.sacasd/config/adrbook.json https://snapshot.notional.ventures/sacas/addrbook.json
...
export SACASD_P2P_MAX_NUM_INBOUND_PEERS=200
export SACASD_P2P_MAX_NUM_OUTBOUND_PEERS=200
export SACASD_STATESYNC_RPC_SERVERS="https://sacas-rpc.polkachu.com:443,https://rpc-sacas-ia.notional.ventures:443"
