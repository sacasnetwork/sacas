...
HTTPS_GIT := https://github.com/sacas/sacas.git
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/sacas/sacas"
	godoc -http=:6060
...
PACKAGE_NAME:=github.com/sacas/sacas
