...
func init() {
	file_sacas_vesting_v1_vesting_proto_init()
	md_ClawbackVestingAccount = File_sacas_vesting_v1_vesting_proto.Messages().ByName("ClawbackVestingAccount")
...
func (x *ClawbackVestingAccount) slowProtoReflect() protoreflect.Message {
	mi := &file_sacas_vesting_v1_vesting_proto_msgTypes[0]
...
func (x *fastReflection_ClawbackVestingAccount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sacas.vesting.v1.ClawbackVestingAccount.base_vesting_account":
		return x.BaseVestingAccount != nil
	case "sacas.vesting.v1.ClawbackVestingAccount.funder_address":
		return x.FunderAddress != ""
	case "sacas.vesting.v1.ClawbackVestingAccount.start_time":
		return x.StartTime != nil
	case "sacas.vesting.v1.ClawbackVestingAccount.lockup_periods":
		return len(x.LockupPeriods) != 0
	case "sacas.vesting.v1.ClawbackVestingAccount.vesting_periods":
		return len(x.VestingPeriods) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sacas.vesting.v1.ClawbackVestingAccount"))
		}
		panic(fmt.Errorf("message sacas.vesting.v1.ClawbackVestingAccount does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ClawbackVestingAccount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sacas.vesting.v1.ClawbackVestingAccount does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ClawbackVestingAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sacas.vesting.v1.ClawbackVestingAccount.vesting_periods":
		...
		return protoreflect.ValueOfList(value)
	case "sacas.vesting.v1.ClawbackVestingAccount.funder_address":
		panic(fmt.Errorf("field funder_address of message sacas.vesting.v1.ClawbackVestingAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sacas.vesting.v1.ClawbackVestingAccount"))
		}
...
func (x *fastReflection_ClawbackVestingAccount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sacas.vesting.v1.ClawbackVestingAccount", d.FullName()))
	}
	panic("unreachable")
}
...
func (*ClawbackVestingAccount) Descriptor() ([]byte, []int) {
	return file_sacas_vesting_v1_vesting_proto_rawDescGZIP(), []int{0}
}
...
var File_sacas_vesting_v1_vesting_proto protoreflect.FileDescriptor

var file_sacas_vesting_v1_vesting_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x73, 0x61, 0x63, 0x61, 0x73, 0x2f, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2f,
	0x76, 0x31, 0x2f, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x10, 0x73, 0x61, 0x63, 0x61, 0x73, 0x2e, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e,
	...
	0x64, 0x73, 0x3a, 0x08, 0x88, 0xa0, 0x1f, 0x00, 0x98, 0xa0, 0x1f, 0x00, 0x42, 0xb3, 0x01, 0x0a,
	0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x61, 0x63, 0x61, 0x73, 0x2e, 0x76, 0x65, 0x73, 0x74, 0x69,
	...
	,
}

var (
	file_sacas_vesting_v1_vesting_proto_rawDescOnce sync.Once
	file_sacas_vesting_v1_vesting_proto_rawDescData = file_sacas_vesting_v1_vesting_proto_rawDesc
)

func file_sacas_vesting_v1_vesting_proto_rawDescGZIP() []byte {
	file_sacas_vesting_v1_vesting_proto_rawDescOnce.Do(func() {
		file_sacas_vesting_v1_vesting_proto_rawDescData = protoimpl.X.CompressGZIP(file_sacas_vesting_v1_vesting_proto_rawDescData)
	})
	return file_sacas_vesting_v1_vesting_proto_rawDescData
}

var file_sacas_vesting_v1_vesting_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sacas_vesting_v1_vesting_proto_goTypes = []interface{}{
	(*ClawbackVestingAccount)(nil),     // 0: sacas.vesting.v1.ClawbackVestingAccount
...
var file_sacas_vesting_v1_vesting_proto_depIdxs = []int32{
	1, // 0: sacas.vesting.v1.ClawbackVestingAccount.base_vesting_account:type_name -> cosmos.vesting.v1beta1.BaseVestingAccount
	2, // 1: sacas.vesting.v1.ClawbackVestingAccount.start_time:type_name -> google.protobuf.Timestamp
	3, // 2: sacas.vesting.v1.ClawbackVestingAccount.lockup_periods:type_name -> cosmos.vesting.v1beta1.Period
	3, // 3: sacas.vesting.v1.ClawbackVestingAccount.vesting_periods:type_name -> cosmos.vesting.v1beta1.Period
...
func init() { file_sacas_vesting_v1_vesting_proto_init() }
func file_sacas_vesting_v1_vesting_proto_init() {
	if File_sacas_vesting_v1_vesting_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_sacas_vesting_v1_vesting_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sacas_vesting_v1_vesting_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sacas_vesting_v1_vesting_proto_goTypes,
		DependencyIndexes: file_sacas_vesting_v1_vesting_proto_depIdxs,
		MessageInfos:      file_sacas_vesting_v1_vesting_proto_msgTypes,
	}.Build()
	File_sacas_vesting_v1_vesting_proto = out.File
	file_sacas_vesting_v1_vesting_proto_rawDesc = nil
	file_sacas_vesting_v1_vesting_proto_goTypes = nil
	file_sacas_vesting_v1_vesting_proto_depIdxs = nil
}
