...
func (n *IntegrationNetwork) configureAndInitChain() error {
	...
	sacasApp := createSacasApp(n.cfg.chainID)

	// Configure Genesis state
	genesisState := app.NewDefaultGenesisState()

	genesisState = setAuthGenesisState(sacasApp, genesisState, genAccounts)
	...
	genesisState = setStakingGenesisState(sacasApp, genesisState, stakingParams)

	genesisState = setInflationGenesisState(sacasApp, genesisState)
	...
	genesisState = setBankGenesisState(sacasApp, genesisState, bankParams)
	...
	sacasApp.BeginBlock(abcitypes.RequestBeginBlock{Header: header})

	// Set networks global parameters
	n.app = sacasApp
	// TODO - this might not be the best way to initilize the context
	n.ctx = sacasApp.BaseApp.NewContext(false, header)
