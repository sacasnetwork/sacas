...
func createSacasApp(chainID string) *app.Sacas {
	// Create sacas app
	db := dbm.NewMemDB()
...
func setStakingGenesisState(sacasApp *app.Sacas, genesisState simapp.GenesisState, overwriteParams StakingCustomGenesisState) simapp.GenesisState {
	// Set staking params
...
func setAuthGenesisState(sacasApp *app.Sacas, genesisState simapp.GenesisState, genAccounts []authtypes.GenesisAccount) simapp.GenesisState {
	authGenesis := authtypes.NewGenesisState(authtypes.DefaultParams(), genAccounts)
	genesisState[authtypes.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(authGenesis)
	return genesisState
}

// setInflationGenesisState sets the inflation genesis state
func setInflationGenesisState(sacasApp *app.Sacas, genesisState simapp.GenesisState) simapp.GenesisState {
	...
	genesisState[infltypes.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(&inflationGenesis)
	return genesisState
}
...
func setBankGenesisState(sacasApp *app.Sacas, genesisState simapp.GenesisState, overwriteParams BankCustomGenesisState) simapp.GenesisState {
