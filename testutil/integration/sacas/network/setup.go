...
import (
	...
	"github.com/sacasnetwork/sacas/v20/app"
	...
	infltypes "github.com/sacasnetwork/sacas/v20/x/inflation/v1/types"

	evmtypes "github.com/sacasnetwork/sacas/v20/x/evm/types"
)

// genSetupFn is the type for the module genesis setup functions
type genSetupFn func(sacasApp *app.Sacas, genesisState sacastypes.GenesisState, customGenesis interface{}) (sacastypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *app.Sacas, genesisState sacastypes.GenesisState, _ interface{}) (sacastypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(sacasApp *app.Sacas, genesisState sacastypes.GenesisState, customGenesis interface{}) (sacastypes.GenesisState, error) {
		moduleGenesis, ok := customGenesis.(T)
		if !ok {
			return nil, fmt.Errorf("invalid type %T for %s module genesis state", customGenesis, moduleName)
		}

		genesisState[moduleName] = sacasApp.AppCodec().MustMarshalJSON(moduleGenesis)
		return genesisState, nil
	}
}
...
// createSacasApp creates an sacas app
func createSacasApp(chainID string, customBaseAppOptions ...func(*baseapp.BaseApp)) *app.Sacas {
	// Create sacas app
	db := dbm.NewMemDB()
...
func setDefaultStakingGenesisState(sacasApp *app.Sacas, genesisState sacastypes.GenesisState, overwriteParams StakingCustomGenesisState) sacastypes.GenesisState {
	// Set staking params
	...
	genesisState[stakingtypes.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(stakingGenesis)
	return genesisState
}
...
func setDefaultBankGenesisState(sacasApp *app.Sacas, genesisState sacastypes.GenesisState, overwriteParams BankCustomGenesisState) sacastypes.GenesisState {
	...
	genesisState[banktypes.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(bankGenesis)
	return genesisState
}
...
func setDefaultSlashingGenesisState(sacasApp *app.Sacas, genesisState sacastypes.GenesisState, overwriteParams SlashingCustomGenesisState) sacastypes.GenesisState {
	...
	genesisState[slashingtypes.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(slashingGen)
	return genesisState
}

// setBankGenesisState updates the bank genesis state with custom genesis state
func setBankGenesisState(sacasApp *app.Sacas, genesisState sacastypes.GenesisState, customGenesis interface{}) (sacastypes.GenesisState, error) {
	...
	sacasApp.AppCodec().MustUnmarshalJSON(genesisState[banktypes.ModuleName], bankGen)
	...
	genesisState[banktypes.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(bankGen)
	return genesisState, nil
}
...
func setDefaultAuthGenesisState(sacasApp *app.Sacas, genesisState sacastypes.GenesisState, genAccs []authtypes.GenesisAccount) sacastypes.GenesisState {
	defaultAuthGen := authtypes.NewGenesisState(authtypes.DefaultParams(), genAccs)
	genesisState[authtypes.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(defaultAuthGen)
	return genesisState
}

// setAuthGenesisState updates the bank genesis state with custom genesis state
func setAuthGenesisState(sacasApp *app.Sacas, genesisState sacastypes.GenesisState, customGenesis interface{}) (sacastypes.GenesisState, error) {
	...
	sacasApp.AppCodec().MustUnmarshalJSON(genesisState[authtypes.ModuleName], authGen)
	...
	genesisState[authtypes.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(authGen)
	return genesisState, nil
}
...
func setDefaultGovGenesisState(sacasApp *app.Sacas, genesisState sacastypes.GenesisState, overwriteParams GovCustomGenesisState) sacastypes.GenesisState {
	...
	genesisState[govtypes.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(govGen)
	return genesisState
}

func setDefaultErc20GenesisState(sacasApp *app.Sacas, genesisState sacastypes.GenesisState) sacastypes.GenesisState {
	erc20Gen := erc20types.DefaultGenesisState()
	genesisState[erc20types.ModuleName] = sacasApp.AppCodec().MustMarshalJSON(erc20Gen)
	return genesisState
}

// defaultAuthGenesisState sets the default genesis state
// for the testing setup
func newDefaultGenesisState(sacasApp *app.Sacas, params defaultGenesisParams) sacastypes.GenesisState {
	genesisState := sacasApp.DefaultGenesis()

	genesisState = setDefaultAuthGenesisState(sacasApp, genesisState, params.genAccounts)
	genesisState = setDefaultStakingGenesisState(sacasApp, genesisState, params.staking)
	genesisState = setDefaultBankGenesisState(sacasApp, genesisState, params.bank)
	genesisState = setDefaultGovGenesisState(sacasApp, genesisState, params.gov)
	genesisState = setDefaultSlashingGenesisState(sacasApp, genesisState, params.slashing)
	genesisState = setDefaultErc20GenesisState(sacasApp, genesisState)
...
func customizeGenesis(sacasApp *app.Sacas, customGen CustomGenesisState, genesisState sacastypes.GenesisState) (sacastypes.GenesisState, error) {
	var err error
	for mod, modGenState := range customGen {
		if fn, found := genesisSetupFunctions[mod]; found {
			genesisState, err = fn(sacasApp, genesisState, modGenState)
			if err != nil {
