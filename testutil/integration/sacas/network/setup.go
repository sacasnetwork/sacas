...
type genSetupFn func(evmosApp *app.Sacas, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *app.Sacas, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(evmosApp *app.Sacas, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
...
// createSacasApp creates an evmos app
...
func setDefaultStakingGenesisState(evmosApp *app.Sacas, genesisState evmostypes.GenesisState, overwriteParams StakingCustomGenesisState) evmostypes.GenesisState {
	// Set staking params
...
func setDefaultBankGenesisState(evmosApp *app.Sacas, genesisState evmostypes.GenesisState, overwriteParams BankCustomGenesisState) evmostypes.GenesisState {
...
func setDefaultSlashingGenesisState(evmosApp *app.Sacas, genesisState evmostypes.GenesisState, overwriteParams SlashingCustomGenesisState) evmostypes.GenesisState {
...
func setBankGenesisState(evmosApp *app.Sacas, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
...
func setDefaultAuthGenesisState(evmosApp *app.Sacas, genesisState evmostypes.GenesisState, genAccs []authtypes.GenesisAccount) evmostypes.GenesisState {
...
func setAuthGenesisState(evmosApp *app.Sacas, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
...
func setDefaultGovGenesisState(evmosApp *app.Sacas, genesisState evmostypes.GenesisState, overwriteParams GovCustomGenesisState) evmostypes.GenesisState {
...
func setDefaultErc20GenesisState(evmosApp *app.Sacas, genesisState evmostypes.GenesisState) evmostypes.GenesisState {
...
func newDefaultGenesisState(evmosApp *app.Sacas, params defaultGenesisParams) evmostypes.GenesisState {
...
func customizeGenesis(evmosApp *app.Sacas, customGen CustomGenesisState, genesisState evmostypes.GenesisState) (evmostypes.GenesisState, error) {
	var err error
