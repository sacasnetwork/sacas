...
// the WSAC and the provided denoms.
...
func CreateGenesisWithTokenPairs(keyring testkeyring.Keyring, denoms ...string) network.CustomGenesisState {
	...
	wevmosAddr := common.HexToAddress(erc20types.WSACContractTestnet).Hex()
	...
	// with the WSAC (default is mainnet) and 'xmpl' tokens in the erc20 params
