...
import (
	...
	"github.com/sacasnetwork/sacas/v15/testutil/integration/grpc"
	"github.com/sacasnetwork/sacas/v15/testutil/integration/network"
...
type CosmosTxArgs struct {
	// ChainID is the chain's id in cosmos format, e.g. 'sacas_1317-1'
	ChainID string
