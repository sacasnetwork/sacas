def test_single_request_netversion(sacas_cluster):
    sacas_cluster.use_websocket()
    eth_ws = sacas_cluster.w3.provider
...
def test_batch_request_netversion(sacas):
    return


def test_ws_subscribe_log(sacas):
    return


def test_ws_subscribe_newheads(sacas):
    return
