...
def test_grpc_mode(custom_sacas):
    """
    ...
    api_port = ports.api_port(custom_sacas.base_port(1))
    ...
    for i in range(2):
        wait_for_block(custom_sacas.cosmos_cli(i), 1)
    ...
    with (custom_sacas.base_dir / "node1.log").open("a") as logfile:
        ...
        try:
            ...
            grpc_port = ports.grpc_port(custom_sacas.base_port(1))
            ...
            addr = custom_sacas.cosmos_cli(0).consensus_address()
