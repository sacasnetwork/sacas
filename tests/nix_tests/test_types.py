...
def test_block(sacas, geth):
    ...
    get_blocks(sacas, geth, False)
    # Case 2: block with transactions
    get_blocks(sacas, geth, True)
...
def test_accounts(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_syncing(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(sacas_rpc_ws, geth):
...
def test_get_code(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(sacas_rpc_ws, geth):
    w3: Web3 = sacas_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(sacas_rpc_ws, geth):
...
def test_incomplete_send_transaction(sacas_rpc_ws, geth):
