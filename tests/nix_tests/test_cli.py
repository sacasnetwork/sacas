...
def test_block_cmd(evmos_cluster):
    ...
    # stop node1
    supervisorctl(evmos_cluster.base_dir / "../tasks.ini", "stop", "sac_1312-1-node1")
    ...
    # start node1 again
    supervisorctl(
        evmos_cluster.base_dir / "../tasks.ini", "start", "sac_1312-1-node1"
    )
    ...
    test_cases = [
        {
            ...
            "flags": {"fees": "5000000000sac", "gas_prices": "50000sac"},
            "exp_err": True,
        ...
        },
        {
            ...
            "flags": {"fees": "10sac", "gas": 50000, "gas_prices": None},
            "exp_err": True,
            "err_msg": "insufficient fee",
        },
        {
            "name": "fail - insufficient gas",
            "flags": {"fees": "500000000000sac", "gas": 1, "gas_prices": None},
            "exp_err": True,
            "err_msg": "out of gas",
        },
        {
        ...
        },
        {
            ...
            "flags": {"gas_prices": "100000000000sac", "gas": 1500000},
            "exp_err": False,
            "err_msg": None,
        },
        {
