...
def test_block_cmd(sacas):
    ...
    # wait for height 10
    node1 = sacas.cosmos_cli(1)
    wait_for_block(node1, 10)

    # stop node1
    supervisorctl(sacas.base_dir / "../tasks.ini", "stop", "sacas_1317-1-node1")
    ...
    # start node1 again
    supervisorctl(sacas.base_dir / "../tasks.ini", "start", "sacas_1317-1-node1")
