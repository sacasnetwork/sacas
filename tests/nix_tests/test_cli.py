...
def test_block_cmd(sacas_cluster):
    """
    - start 2 sacas nodes
    ...
    node1 = sacas_cluster.cosmos_cli(1)
...
def test_tx_flags(sacas_cluster):
    ...
    test_cases = [
        {
            ...
            "flags": {"fees": "5000000000asacas", "gas_prices": "50000asacas"},
            "exp_err": True,
        ...
        },
        {
            ...
            "flags": {"fees": "10asacas", "gas": 50000, "gas_prices": None},
            "exp_err": True,
            "err_msg": "insufficient fee",
        },
        {
            "name": "fail - insufficient gas",
            "flags": {"fees": "500000000000asacas", "gas": 1, "gas_prices": None},
            "exp_err": True,
            "err_msg": "out of gas",
        },
        {
            ...
            "flags": {
                "fees": "10000000000000000000asacas",
                "gas": 1500000,
                "gas_prices": None,
            },
            "exp_err": False,
        ...
        },
        {
            ...
            "flags": {"gas_prices": "100000000000asacas", "gas": 1500000},
            "exp_err": False,
            "err_msg": None,
        },
        {
    ...
    for tc in test_cases:
        try:
            res = node.transfer(
                "signer1",
                "sacas10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky",
                "100000000000000asacas",
                False,
                **tc["flags"],
            )
            if not tc["exp_err"]:
