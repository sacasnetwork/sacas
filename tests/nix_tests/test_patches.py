    ...
    test_cases = [
        {
            ...
            "exp_err": "invalid decimal coin expression: -10000000000sac",
            "lockup": {
                "start_time": 1625204910,
                "periods": [
                    {
                        "length_seconds": 2419200,
                        "coins": "10000000000sac",
                    }
                ],
            },
            "vesting": {
...
def test_unvested_token_delegation(evmos_cluster):
    ...
    del_amt = "7000000000000000000sac"
