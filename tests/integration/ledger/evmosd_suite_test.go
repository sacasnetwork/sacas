...
import (
	...
	"github.com/sacasnetwork/sacas/v20/tests/integration/ledger/mocks"
	...
	clientkeys "github.com/sacasnetwork/sacas/v20/client/keys"
	sacaskeyring "github.com/sacasnetwork/sacas/v20/crypto/keyring"
...
func (suite *LedgerTestSuite) SetupSacasApp() {
...
func (suite *LedgerTestSuite) sacasAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = sacaskeyring.SupportedAlgorithms
		options.SupportedAlgosLedger = sacaskeyring.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = sacaskeyring.CreatePubkey
		options.LedgerAppName = sacaskeyring.AppName
		options.LedgerSigSkipDERConv = sacaskeyring.SkipDERConversion
	}
}
