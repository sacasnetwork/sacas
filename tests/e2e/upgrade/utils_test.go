...
// TestSacasVersionsLess tests the SacasVersions type's Less method with
// different version strings
func TestSacasVersionsLess(t *testing.T) {
	var version SacasVersions
...
// TestSacasVersionsSwap tests the SacasVersions type's Swap method
func TestSacasVersionsSwap(t *testing.T) {
	var version SacasVersions
	value := "v9.1.0"
...
// TestSacasVersionsLen tests the SacasVersions type's Len method
func TestSacasVersionsLen(t *testing.T) {
	var version SacasVersions = []string{"v9.1.0", "v10.0.0"}
