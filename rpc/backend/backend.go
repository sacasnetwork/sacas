...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*sacastypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*sacastypes.TxResult, error)
...
type Backend struct {
	...
	indexer             sacastypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := sacastypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
