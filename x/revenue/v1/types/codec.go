...
const (
	// Amino names
	cancelRevenueName   = "sacas/MsgCancelRevenue"
	registerRevenueName = "sacas/MsgRegisterRevenue"
	updateRevenueName   = "sacas/MsgUpdateRevenue"
	updateParamsName    = "sacas/MsgUpdateParams"
)
