...
import (
	...
	sacascore "github.com/sacasnetwork/sacas/v20/x/evm/core/core"
...
// RANDAO implementation. See https://github.com/sacasnetwork/ethermint/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		CanTransfer: sacascore.CanTransfer,
		Transfer:    sacascore.Transfer,
		GetHash:     k.GetHashFn(ctx),
		Coinbase:    cfg.CoinBase,
		GasLimit:    sacastypes.BlockGasLimit(ctx),
	...
	txCtx := sacascore.NewEVMTxContext(msg)
	if tracer == nil {
...
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := sacastypes.SafeInt64(height)
		if err != nil {
...
func (k *Keeper) ApplyMessageWithConfig(
	...
	// for more info https://github.com/sacasnetwork/ethermint/issues/1085
