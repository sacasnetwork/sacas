...
func (suite *ParamsTestSuite) TestParamsValidate() {
	testCases := []struct {
		...
		},
		{
			...
			func() types.Params { return types.NewParams(true, []string{}, []string{types.WSACASContractMainnet}) },
			false,
			"",
		},
		{
			"valid address - native precompile",
			func() types.Params { return types.NewParams(true, []string{types.WSACASContractMainnet}, []string{}) },
			false,
			"",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{types.WSACASContractTestnet, types.WSACASContractMainnet}, []string{})
			},
			false,
			"",
		},
		{
			...
			// order of creation shouldn't matter since it should be sorted when defining new param
			func() types.Params {
				return types.NewParams(true, []string{types.WSACASContractMainnet, types.WSACASContractTestnet}, []string{})
			},
			false,
			"",
		},
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{types.WSACASContractMainnet}, []string{types.WSACASContractMainnet})
			},
			true,
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{types.WSACASContractMainnet, types.WSACASContractMainnet}, []string{})
			},
			true,
			"duplicate precompile",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{}, []string{types.WSACASContractMainnet, types.WSACASContractMainnet})
			},
			true,
			"duplicate precompile",
		},
		...
		},
		{
			...
			func() types.Params {
				...
				params.NativePrecompiles = []string{types.WSACASContractTestnet, types.WSACASContractMainnet}
				return params
			},
			true,
...
func (suite *ParamsTestSuite) TestIsNativePrecompile() {
	testCases := []struct {
	...
	}{
		{
			"default",
			types.DefaultParams,
			common.HexToAddress(types.WSACASContractMainnet),
			true,
		},
		{
		...
		},
		{
			...
			common.HexToAddress(types.WSACASContractTestnet),
			true,
		},
		{
