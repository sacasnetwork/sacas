	...
	testCases := []struct {
	...
	}{
		{
			...
			banktypes.Metadata{
				...
				Name:        "Sacas",
				Symbol:      "SACAS",
				Description: "EVM, staking and governance denom of Sacas",
				DenomUnits: []*banktypes.DenomUnit{
					{
						Denom:    "asacas",
						Exponent: 0,
						Aliases:  []string{"atto sacas"},
					},
					{
						Denom:    "sacas",
						Exponent: 18,
...
func TestEqualAliases(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			[]string{"atto sacas", "asacas"},
			[]string{"asacas", "atto sacas"},
			false,
		},
		{
			"same values, sorted",
