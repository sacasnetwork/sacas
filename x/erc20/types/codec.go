...
const (
	// Amino names
	convertERC20Name = "sacas/MsgConvertERC20"
	convertCoinName  = "sacas/MsgConvertCoin" // keep it for backwards compatibility when querying txs
	updateParams     = "sacas/erc20/MsgUpdateParams"
	registerERC20    = "sacas/erc20/MsgRegisterERC20"
	toggleConversion = "sacas/erc20/MsgToggleConversion"
)
