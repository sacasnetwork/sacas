...
import (
	...
	"github.com/sacasnetwork/sacas/v20/x/erc20/keeper"
	...
	"github.com/sacasnetwork/sacas/v20/testutil"
...
func (suite *KeeperTestSuite) TestOnRecvPacket() {
	...
	for _, tc := range testCases {
		suite.Run(fmt.Sprintf("Case %s", tc.name), func() {
			...
			suite.network.App.IBCKeeper.ChannelKeeper.SetChannel(ctx, transfertypes.PortID, sacasChannel, channel)

			// Set Next Sequence Send
			suite.network.App.IBCKeeper.ChannelKeeper.SetNextSequenceSend(ctx, transfertypes.PortID, sacasChannel, 1)
