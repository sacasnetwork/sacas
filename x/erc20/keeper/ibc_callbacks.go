...
// registered via governance. Note that the native staking denomination (e.g. "asacas"),
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	// assume that all module accounts on Sacas need to have their tokens in the
