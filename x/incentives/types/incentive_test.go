...
func (suite *IncentiveTestSuite) TestIncentiveNew() {
	testCases := []struct {
	...
	}{
		{
			...
			sdk.DecCoins{sdk.NewDecCoinFromDec("asacas", sdk.NewDecWithPrec(5, 2))},
			10,
			true,
		},
		{
		...
		},
		{
			...
			utiltx.GenerateAddress(),
			sdk.DecCoins{{Denom: "(sacas", Amount: sdk.OneDec()}},
			10,
			false,
		},
		{
			...
			utiltx.GenerateAddress(),
			sdk.DecCoins{sdk.NewDecCoinFromDec("asacas", sdk.NewDecWithPrec(0, 2))},
			10,
			false,
		},
		{
			...
			utiltx.GenerateAddress(),
			sdk.DecCoins{sdk.NewDecCoinFromDec("asacas", sdk.NewDecWithPrec(101, 2))},
			10,
			false,
		},
		{
