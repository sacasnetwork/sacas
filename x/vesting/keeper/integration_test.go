...
import (
	...
	"github.com/sacasnetwork/sacas/v20/x/vesting/types"
...
type KeeperTestSuite struct {
	...
	factory sacasfactory.TxFactory
}
...
//
// Example:
// 21/10 Employee joins Sacas and vesting starts
...
var _ = Describe("Clawback Vesting Account - Smart contract", func() {
	...
	BeforeEach(func() {
		...
		contractAddr, err = s.factory.DeployContract(
			...
			evmtypes.EvmTxArgs{},
			sacasfactory.ContractDeploymentData{
				Contract:        contract,
