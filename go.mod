module github.com/sacasnetwork/sacas/v15
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/sacasnetwork/cosmos-sdk v0.47.0-sac
	// use Sacas geth fork
	github.com/ethereum/go-ethereum => github.com/sacasnetwork/go-ethereum v1.10.26-sac-rc2
