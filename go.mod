...
replace (
	...
	cosmossdk.io/store => github.com/sacasnetwork/cosmos-sdk/store v0.50.9-sacnet
	// use cosmos fork of keyring
	github.com/99designs/keyring => github.com/cosmos/keyring v1.2.0
	github.com/cosmos/cosmos-sdk => github.com/sacasnetwork/cosmos-sdk v0.50.9-sacnetest
