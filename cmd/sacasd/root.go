...
import (
	...
	sacasclient "github.com/sacasnetwork/sacas/v20/client"
	"github.com/sacasnetwork/sacas/v20/client/block"
	"github.com/sacasnetwork/sacas/v20/client/debug"
	sacasserver "github.com/sacasnetwork/sacas/v20/server"
	servercfg "github.com/sacasnetwork/sacas/v20/server/config"
	srvflags "github.com/sacasnetwork/sacas/v20/server/flags"

	"github.com/sacasnetwork/sacas/v20/app"
	cmdcfg "github.com/sacasnetwork/sacas/v20/cmd/config"
	sacaskr "github.com/sacasnetwork/sacas/v20/crypto/keyring"
)

const EnvPrefix = "SACAS"
...
func (a appCreator) appExport(
	...
	if height != -1 {
		sacasApp = app.NewSacas(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), appOpts)

		if err := sacasApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		sacasApp = app.NewSacas(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), appOpts)
	}
