...
import (
	...
	evmosclient "github.com/sacasnetwork/sacas/v1/client"
	"github.com/sacasnetwork/sacas/v1/client/block"
	"github.com/sacasnetwork/sacas/v1/client/debug"
	evmosserver "github.com/sacasnetwork/sacas/v1/server"
	...
	evmoskr "github.com/sacasnetwork/sacas/v1/crypto/keyring"
)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		evmosApp = app.NewSacas(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), appOpts)

		if err := evmosApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		evmosApp = app.NewSacas(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), appOpts)
	}
