...
import (
	...
	teststypes "github.com/sacasnetwork/sacas/v20/types/tests"
)
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		{
			name: "valid - cosmos sender, sacas recipient",
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
				Receiver: "sacas1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Amount:   "123456",
			},
			expSender:    "sacas1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expRecipient: "sacas1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expError:     false,
		},
		{
			name: "valid - sacas sender, cosmos recipient",
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "sacas1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Receiver: "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
				Amount:   "123456",
			},
			expSender:    "sacas1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expRecipient: "sacas1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expError:     false,
		},
		{
			name: "valid - osmosis sender, sacas recipient",
			data: transfertypes.FungibleTokenPacketData{
...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"10",
			sdk.Coin{Denom: "asacas", Amount: math.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer/channel-0/asacas",
			"10",
			sdk.Coin{Denom: teststypes.AsacasIbcdenom, Amount: math.NewInt(10)},
		},
		{
...
func TestDeriveDecimalsFromDenom(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expDec:    0,
			expFail:   true,
			expErrMsg: "Should be either micro ('u[...]') or atto ('a[...]'); got: \"nsacas\"",
		},
		{
