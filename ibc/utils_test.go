...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "cosmos1",
				Receiver: "sac1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Amount:   "123456",
			},
			expSender:    "",
			expRecipient: "",
		...
		},
		{
			...
			expSender:    "sac1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expRecipient: "sac1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expError:     false,
		},
		{
			name: "valid - evmos sender, cosmos recipient",
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "sac1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Receiver: "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
				Amount:   "123456",
			},
			expSender:    "sac1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expRecipient: "sac1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expError:     false,
		},
		{
...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/sac",
			"10",
			sdk.Coin{Denom: "sac", Amount: math.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped sac coin",
			"sac",
			"10",
			sdk.Coin{Denom: "sac", Amount: math.NewInt(10)},
		},
		{
			"get ibc wrapped sac coin",
			"transfer/channel-0/sac",
			"10",
			sdk.Coin{Denom: teststypes.sacIbcdenom, Amount: math.NewInt(10)},
		},
		{
