...
import (
	...
	"github.com/sacasnetwork/sacas/v15/wallets/accounts"
	"github.com/sacasnetwork/sacas/v15/wallets/usbwallet"
)
...
func (e SacasSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte) ([]byte, error) {
