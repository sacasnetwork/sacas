...
import (
	...
	cryptocodec "github.com/sacasnetwork/sacas/v20/crypto/codec"
	enccodec "github.com/sacasnetwork/sacas/v20/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("sacas", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, sacastypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, sacastypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(sacastypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Sacas implementation
	...
	// Equality of Eth and Sacas implementation
	...
	// Inequality of wrong derivation path of Eth and Sacas implementation
