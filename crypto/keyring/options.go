...
import (
	...
	"github.com/sacasnetwork/sacas/v20/wallets/ledger"
)

// AppName defines the Ledger app used for signing. Sacas uses the Ethereum app
const AppName = "Ethereum"

var (
	// SupportedAlgorithms defines the list of signing algorithms used on Sacas:
	//  - eth_secp256k1 (Ethereum)
	SupportedAlgorithms = keyring.SigningAlgoList{hd.EthSecp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on Sacas for the Ledger device:
	...
	// LedgerDerivation defines the Sacas Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.SacasLedgerDerivation()
