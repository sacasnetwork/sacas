...
// NewSacasCoin is a utility function that returns an "sac" coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewSacasCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoSacas, amount)
}

// NewSacasDecCoin is a utility function that returns an "sac" decimal coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewSacasDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoSacas, amount)
}

// NewSacasCoinInt64 is a utility function that returns an "sac" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
