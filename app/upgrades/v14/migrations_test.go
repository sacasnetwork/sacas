...
func (s *UpgradesTestSuite) TestUpdateMigrateNativeMultisigs() {
	...
	var (
		...
		stratRes1SacasCoin = sdk.Coin{Denom: s.bondDenom, Amount: amount1}
	...
	// assign pre-balances
	oldStrategicReserves[0].BalancePre = sdk.NewCoins(stratRes1SacasCoin, stratRes1IBCCoin)
	...
	newStrategicReserve.BalancePost = sdk.NewCoins(
		stratRes1IBCCoin,
		stratRes1SacasCoin.Add(stratRes2Coin).Add(stratRes3Coin).Add(stratRes4Coin).Add(stratRes5Coin),
	)
