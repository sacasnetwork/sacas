...
import (
	...
	evmante "github.com/sacasnetwork/sacas/v15/app/ante/evm"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.app = app.EthSetup(checkTx, func(app *app.Sacas, genesis simapp.GenesisState) simapp.GenesisState {
