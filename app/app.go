...
import (
	...
	_ "github.com/sacasnetwork/sacas/v15/client/docs/statik"

	"github.com/sacasnetwork/sacas/v15/app/ante"
	ethante "github.com/sacasnetwork/sacas/v15/app/ante/evm"
	v10 "github.com/sacasnetwork/sacas/v15/app/upgrades/v10"
	v11 "github.com/sacasnetwork/sacas/v15/app/upgrades/v11"
	v12 "github.com/sacasnetwork/sacas/v15/app/upgrades/v12"
	v13 "github.com/sacasnetwork/sacas/v15/app/upgrades/v13"
	v14 "github.com/sacasnetwork/sacas/v15/app/upgrades/v14"
	v15 "github.com/sacasnetwork/sacas/v15/app/upgrades/v15"
	v8 "github.com/sacasnetwork/sacas/v15/app/upgrades/v8"
	v81 "github.com/sacasnetwork/sacas/v15/app/upgrades/v8_1"
	v82 "github.com/sacasnetwork/sacas/v15/app/upgrades/v8_2"
	v9 "github.com/sacasnetwork/sacas/v15/app/upgrades/v9"
	v91 "github.com/sacasnetwork/sacas/v15/app/upgrades/v9_1"
	"github.com/sacasnetwork/sacas/v15/encoding"
	"github.com/sacasnetwork/sacas/v15/ethereum/eip712"
	"github.com/sacasnetwork/sacas/v15/precompiles/common"
	srvflags "github.com/sacasnetwork/sacas/v15/server/flags"
	sacastypes "github.com/sacasnetwork/sacas/v15/types"
	"github.com/sacasnetwork/sacas/v15/x/claims"
	claimskeeper "github.com/sacasnetwork/sacas/v15/x/claims/keeper"
	claimstypes "github.com/sacasnetwork/sacas/v15/x/claims/types"
	"github.com/sacasnetwork/sacas/v15/x/epochs"
	epochskeeper "github.com/sacasnetwork/sacas/v15/x/epochs/keeper"
	epochstypes "github.com/sacasnetwork/sacas/v15/x/epochs/types"
	"github.com/sacasnetwork/sacas/v15/x/erc20"
	erc20client "github.com/sacasnetwork/sacas/v15/x/erc20/client"
	erc20keeper "github.com/sacasnetwork/sacas/v15/x/erc20/keeper"
	erc20types "github.com/sacasnetwork/sacas/v15/x/erc20/types"
	"github.com/sacasnetwork/sacas/v15/x/evm"
	evmkeeper "github.com/sacasnetwork/sacas/v15/x/evm/keeper"
	evmtypes "github.com/sacasnetwork/sacas/v15/x/evm/types"
	"github.com/sacasnetwork/sacas/v15/x/feemarket"
	feemarketkeeper "github.com/sacasnetwork/sacas/v15/x/feemarket/keeper"
	feemarkettypes "github.com/sacasnetwork/sacas/v15/x/feemarket/types"
	"github.com/sacasnetwork/sacas/v15/x/incentives"
	incentivesclient "github.com/sacasnetwork/sacas/v15/x/incentives/client"
	incentiveskeeper "github.com/sacasnetwork/sacas/v15/x/incentives/keeper"
	incentivestypes "github.com/sacasnetwork/sacas/v15/x/incentives/types"
	"github.com/sacasnetwork/sacas/v15/x/inflation"
	inflationkeeper "github.com/sacasnetwork/sacas/v15/x/inflation/keeper"
	inflationtypes "github.com/sacasnetwork/sacas/v15/x/inflation/types"
	"github.com/sacasnetwork/sacas/v15/x/recovery"
	recoverykeeper "github.com/sacasnetwork/sacas/v15/x/recovery/keeper"
	recoverytypes "github.com/sacasnetwork/sacas/v15/x/recovery/types"
	revenue "github.com/sacasnetwork/sacas/v15/x/revenue/v1"
	revenuekeeper "github.com/sacasnetwork/sacas/v15/x/revenue/v1/keeper"
	revenuetypes "github.com/sacasnetwork/sacas/v15/x/revenue/v1/types"
	"github.com/sacasnetwork/sacas/v15/x/vesting"
	vestingclient "github.com/sacasnetwork/sacas/v15/x/vesting/client"
	...
	"github.com/sacasnetwork/sacas/v15/x/ibc/transfer"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".sacasd")

	// manually update the power reduction by replacing micro (u) -> atto (a) sacas
	sdk.DefaultPowerReduction = sacastypes.PowerReduction
...
var (
	_ servertypes.Application = (*Sacas)(nil)
	_ ibctesting.TestingApp   = (*Sacas)(nil)
	_ runtime.AppI            = (*Sacas)(nil)
)

// Sacas implements an extended ABCI application. It is an application
...
func (*Sacas) SimulationManager() *module.SimulationManager {
	panic("unimplemented")
}

// NewSacas returns a reference to a new initialized Ethermint application.
func NewSacas(
	logger log.Logger,
	db dbm.DB,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		...
		sacastypes.ProtoAccount, maccPerms,
...
func (app *Sacas) Name() string { return app.BaseApp.Name() }

func (app *Sacas) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: sacastypes.HasDynamicFeeExtensionOption,
...
func (app *Sacas) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (app *Sacas) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// The DeliverTx method is intentionally decomposed to calculate the transactions per second.
func (app *Sacas) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	defer func() {
...
func (app *Sacas) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *Sacas) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Sacas) ModuleAccountAddrs() map[string]bool {
...
func (app *Sacas) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Sacas's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Sacas) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Sacas's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Sacas) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Sacas's InterfaceRegistry
func (app *Sacas) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Sacas) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Sacas) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Sacas) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Sacas) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Sacas) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Sacas) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Sacas) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Sacas) RegisterNodeService(clientCtx client.Context) {
...
func (app *Sacas) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Sacas) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Sacas) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Sacas) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Sacas) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Sacas) GetTxConfig() client.TxConfig {
...
func (app *Sacas) setupUpgradeHandlers() {
	// v8 upgrade handler
