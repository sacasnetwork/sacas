...
import (
	...
	"github.com/sacasnetwork/sacas/v11/precompiles/staking/testdata"
...
var _ = Describe("Calling staking precompile directly", func() {
	...
	Describe("Redelegations queries", func() {
		...
		It("should return an empty array if no redelegation is found for the given source validator", func() {
			...
			// possible (see https://github.com/sacas/cosmos-sdk/blob/e773cf768844c87245d0c737cda1893a2819dd89/x/staking/keeper/querier.go#L361-L373):
			//
