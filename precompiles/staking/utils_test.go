...
import (
	...
	cmnfactory "github.com/sacasnetwork/sacas/v20/testutil/integration/common/factory"
...
func (s *PrecompileTestSuite) setupVestingAccount(funder, vestAcc testkeyring.Key) *vestingtypes.ClawbackVestingAccount {
	...
	fundMsg := vestingtypes.NewMsgFundVestingAccount(
		...
		vestAcc.AccAddr,
		vestingStart,
		sacasutil.TestVestingSchedule.LockupPeriods,
		sacasutil.TestVestingSchedule.VestingPeriods,
	)
