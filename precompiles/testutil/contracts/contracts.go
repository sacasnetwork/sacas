...
func Call(ctx sdk.Context, app *sacasapp.Sacas, args CallArgs) (res abci.ResponseDeliverTx, ethRes *evmtypes.MsgEthereumTxResponse, err error) {
	var (
		nonce    uint64
...
func CallContractAndCheckLogs(ctx sdk.Context, app *sacasapp.Sacas, cArgs CallArgs, logCheckArgs testutil.LogCheckArgs) (abci.ResponseDeliverTx, *evmtypes.MsgEthereumTxResponse, error) {
