...
import (
	...
	evmosapp "github.com/sacasnetwork/sacas/v1/app"
	"github.com/sacasnetwork/sacas/v1/crypto/ethsecp256k1"
	"github.com/sacasnetwork/sacas/v1/precompiles/testutil"
	evmosutil "github.com/sacasnetwork/sacas/v1/testutil"
	evmtypes "github.com/sacasnetwork/sacas/v1/x/evm/types"
)

// Call is a helper function to call any arbitrary smart contract.
func Call(ctx sdk.Context, app *evmosapp.Sacas, args CallArgs) (res abci.ExecTxResult, ethRes *evmtypes.MsgEthereumTxResponse, err error) {
	var (
		nonce    uint64
...
func CallContractAndCheckLogs(ctx sdk.Context, app *evmosapp.Sacas, cArgs CallArgs, logCheckArgs testutil.LogCheckArgs) (abci.ExecTxResult, *evmtypes.MsgEthereumTxResponse, error) {
