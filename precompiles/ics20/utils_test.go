...
import (
	...
	sacascontracts "github.com/sacasnetwork/sacas/v11/contracts"
	sacasibc "github.com/sacasnetwork/sacas/v11/ibc/testing"
	...
	"github.com/sacasnetwork/sacas/v11/precompiles/testutil/contracts"
...
func (s *PrecompileTestSuite) SetupWithGenesisValSet(chainID string, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) {
	appI, genesisState := sacasapp.SetupTestingApp()
